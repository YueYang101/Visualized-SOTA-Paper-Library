...
export const papers: PaperIndex[] = [
  ...
  },
  {
    ...
    priority: 'medium',
    deepRead: { completed: true, needed: false },
    tags: ['视觉手追踪', '优化重定向', 'CuRobo避碰', '跨形态遥操作', '示教采集'],
    oneMinute:
  ...
  },
  {
    ...
    tags: ['免标定重定向', '跨手形态', '少样本锚点', '捏取接触分类', '视觉手势兼容'],
    oneMinute:
  ...
  },
  {
    ...
    priority: 'very-high',
    deepRead: { completed: false, needed: true },
    tags: ['人手通用接口', '可穿戴外骨骼', '跨形态示教', '触觉采集', '机器人手修补'],
    oneMinute:
  ...
  },
  {
    ...
    priority: 'high',
    deepRead: { completed: false, needed: true },
    tags: ['双臂灵巧遥操', 'Vision Pro追踪', '闭链手重定向', '振动触觉反馈', '示教采集'],
    oneMinute:
